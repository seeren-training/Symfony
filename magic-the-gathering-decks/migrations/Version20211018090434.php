 ...
 */
final class Version20211018090434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, text LONGTEXT DEFAULT NULL, mana_cost VARCHAR(32) DEFAULT NULL, multiverse_id INT NOT NULL, UNIQUE INDEX UNIQ_161498D3713FCA37 (multiverse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
